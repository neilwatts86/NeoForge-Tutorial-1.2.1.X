package net.neilwatts86.muppettutorialmod;

import net.neilwatts86.muppettutorialmod.item.ModItems;
...
@Mod(MuppetTutorialMod.MOD_ID)
public class MuppetTutorialMod {
    public static final String MOD_ID = "muppettutorialmod";
    private static final Logger LOGGER = LogUtils.getLogger();

    public MuppetTutorialMod(IEventBus modEventBus, ModContainer modContainer) {
